...
// CSS2.2 Grammar defines the following, but I'm not sure how to add them to parser for error
// handling BadString : BadUri : BadComment : BadUri :
...
// Variables https://www.w3.org/TR/css-variables-1
